														...
														<div id="member-tab" class="tab-pane">
															<div class="clearfix">
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="${rc.contextPath}/assets/avatars/user.jpg" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Joe Doe's avatar" src="${rc.contextPath}/assets/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Jim Doe's avatar" src="${rc.contextPath}/assets/avatars/avatar.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alex Doe's avatar" src="${rc.contextPath}/assets/avatars/avatar5.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="${rc.contextPath}/assets/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Susan's avatar" src="${rc.contextPath}/assets/avatars/avatar3.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Phil Doe's avatar" src="${rc.contextPath}/assets/avatars/avatar4.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alexa Doe's avatar" src="${rc.contextPath}/assets/avatars/avatar1.png" />
																	</div>
														...
														<div id="comment-tab" class="tab-pane">
															<div class="comments">
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Bob Doe's Avatar" src="${rc.contextPath}/assets/avatars/avatar.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Jennifer's Avatar" src="${rc.contextPath}/assets/avatars/avatar1.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Joe's Avatar" src="${rc.contextPath}/assets/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Rita's Avatar" src="${rc.contextPath}/assets/avatars/avatar3.png" />
																	</div>
												...
												<div class="widget-main no-padding">
													<div class="dialogs">
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Alexa's Avatar" src="${rc.contextPath}/assets/avatars/avatar1.png" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="John's Avatar" src="${rc.contextPath}/assets/avatars/avatar.png" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Bob's Avatar" src="${rc.contextPath}/assets/avatars/user.jpg" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Jim's Avatar" src="${rc.contextPath}/assets/avatars/avatar4.png" />
															</div>
