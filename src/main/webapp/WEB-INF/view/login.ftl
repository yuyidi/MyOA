						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">智慧停车后台管理系统</span>
								</h1>
								<h4 class="blue">&copy; Company 武汉恒达</h4>
							</div>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="userId" class="form-control" placeholder="用户名" value="admin"  />
															<i class="icon-user"></i>
														</span>
													</label>
		...
		<script type="text/javascript">
			...
			$(function(){
				$("#loginbtn").on("click",function(){
					var actionurl="${rc.contextPath}/user/login.json";
					$.ajax({
