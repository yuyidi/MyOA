...
<%@ taglib uri="http://www.opensymphony.com/sitemesh/decorator"
	...
	<div class="page-container">
		<!--container_left 容器左边栏-->
		<%@ include file="/WEB-INF/decorators/container_left.jsp"%>
		<!-- BEGIN CONTENT -->
					...
					<div class="theme-options">
						<div class="theme-option theme-colors clearfix">
							...
							<ul>
								...
								<li class="color-darkblue current tooltips"
...
<%-- 				${body} --%>
				<decorator:body/>
				<!--quik_sidebar 右边菜单-->
				<%@ include file="/WEB-INF/decorators/quick_sidebar.jsp"%>
			</div>
		</div>
		<!-- END CONTENT -->
	</div>
