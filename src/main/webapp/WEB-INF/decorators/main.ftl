...
<![endif]-->
		...
		<script src="${rc.contextPath}/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
					...
					<ul class="nav ace-nav">
						...
						<li class="green">
							...
							<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								...
								<li>
									<a href="#">
										<img src="${rc.contextPath}/assets/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
										<span class="msg-body">
								...
								<li>
									<a href="#">
										<img src="${rc.contextPath}/assets/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
								...
								<li>
									<a href="#">
										<img src="${rc.contextPath}/assets/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
